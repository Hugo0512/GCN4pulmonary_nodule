...
train_x=np.loadtxt('./node2/merge_center1_node_feature.txt')
train_x=minmaxscaler.fit_transform(train_x)
train_edge=np.loadtxt('./node2/merge_center1_adjacent_info_30.txt')
...
train_label=np.loadtxt('./node2/merge_center1_label.txt')
...
test_mask=np.loadtxt('./node2/center1_mask.txt')
...
criterion=torch.nn.CrossEntropyLoss(weight=torch.tensor([5,1]).to(torch.float32),label_smoothing=0.1).to(device)
...
inference1(model,test_graph,'prob_center1_30.txt','logit_center1_30.txt')
